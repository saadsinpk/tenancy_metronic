<x-auth-layout>
    ...
    <!--begin::Signup Form-->
    <form method="POST" action="/register" class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
    @csrf
    ...
    <!--begin::Heading-->
        ...
        <div class="fv-row mb-7">
            <label class="form-label fw-bolder text-dark fs-6">{{ __('Company') }}</label>
            <input class="form-control form-control-lg form-control-solid" type="text" name="company" autocomplete="off" value="{{ old('company') }}"/>
        </div>
        <!--end::Input group-->
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" class="form-control form-control-lg form-control-solid" placeholder="Domain" name="domain">
                <div class="input-group-append">
                    <div class="btn btn-secondary" type="button">.{{config('tenancy.central_domains')[0]}}</div>
                </div>
            </div>
        </div>
